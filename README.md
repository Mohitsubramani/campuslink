...
- [ ] **Phase 2 — Lost & Found** (Pages 4–6)
- [ ] **Phase 3 — Resource Borrowing** (Pages 7–10)
- [ ] **Phase 4 — Give Away** (Page 11)
- [ ] **Phase 5 — Profile & Notifications** (Pages 12–13)
- [ ] **Phase 6 — Gemini AI Embeddings & Vector Search** (Pages 14–17)
